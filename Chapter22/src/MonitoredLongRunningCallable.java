...
class MonitoredCallable implements Callable<String>{
    ...
    public String call(){
        System.out.println(this + " strated");
        try{
            for(int i=0;i<MAX; i++) {
...
public class MonitoredLongRunningCallable extends JFrame{
        ...
        b1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                MonitoredCallable task = new MonitoredCallable(
                        new ProgressMonitor(MonitoredLongRunningCallable.this, "Ling-Running Task", "", 0, 0)
                );
                manager.add(task);
    ...
    public static void main(String[] args) {
        run(new MonitoredLongRunningCallable(), 200, 250);
    }
}