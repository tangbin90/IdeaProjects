/**
 * Created by TangBin on 25/11/2016.
 */
...
class CustomerGeneratr implements Runnable{
    private CustomerLine customers;
    private static Random rand = new Random(47);
    public CustomerGeneratr(CustomerLine cq){
        customers = cq;
    }
...
class Teller implements Runnable, Comparable<Teller>{
    ...
    public synchronized  int compareTo(Teller other){
        return customerServied<other.customerServied?-1:(customerServied==other.customerServied?0:1);
    }
}
...
public class BankTellerSimulation {
    ...
    public static void main(String[] args)throws Exception{
        ...
        exec.execute(new CustomerGeneratr(customers));
